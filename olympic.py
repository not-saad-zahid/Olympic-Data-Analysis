...
if user_menu == 'Athlete-Wise Analysis':
    ...
    # x = []
    # name = []
    # famous_sports = ['Baseketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics', 'Swimming', 'Badminton', 'Sailing', 'Gymnastics', 'Art Competitions', 'Handball', 'Weightlifting', 'Wrerstling', 'Water Polo', 'Hockey', 'Rowing', 'Fencing', 'Shooting', 'Boxing', 'Taekwondo', 'Cycling', 'Diving', 'Conoeing', 'Tennis', 'Golf', 'Softball', 'Archery', 'Volleyball', 'Syncronized Swimming', 'Table Tennis', 'Baseball', 'Rhythmic Gymnastic', 'Rugby Sevens', 'Beach Volleyball', 'Triathlon', 'Rugby', 'Polo', 'Ice Hockey']
